...
const education = [
  {
    period: "2025,Feb -June/2025", 
    Institution: "Refactory Academy.",
    Award: "Certificate in Software Development",
    description:
      "I completed 240 hours of training for the Certificate in Software Development in both technical and non-technical subjects at Refactory Academy.",
    current: false,
  },
  {
    period: "2014 - 2017",
    Institution: "Nkumba University.",
    Award: "Bachelor's Degree in IT",
    description:
              ...
              >
                ...
                >
                  <div className="glass p-6 rounded-2xl border border-primary/30 hover:border-primary/50 transition-all duration-500">
                    ...
                    <h3 className="text-xl font-semibold mt-2">{edu.role}</h3>
